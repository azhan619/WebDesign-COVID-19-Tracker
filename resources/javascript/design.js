...
window.onload = async () => {
    ...
    document.querySelector('#location-tg').onclick = () => {
        document.querySelector('#location-li').classList.toggle('active')
    }
}
...
renderCountrySelectList = (list) => {
    let country_select_list = document.querySelector('#location-li')
    ...
    list.forEach(e => {
        ...
        item.onclick = async () => {
            document.querySelector('#location span').textContent = e.Country
...
loadCountrySelectList = async () => {
    ...
    item.onclick = async () => {
        document.querySelector('#location span').textContent = 'Global'
        country_select_list.classList.toggle('active')
        await loadData('Global')
    }
    country_select_list.appendChild(item)
...
// country filter
initContryFilter = () => {
    let input = document.querySelector('#location-li input')
    input.onkeyup = () => {
